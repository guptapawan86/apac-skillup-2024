# React App - Headless Exercise - Event Landing and Event Detail Page
...
![React App Screenshot](./docs/headless-demo.png)


## How to use

1. On the target AEM environment install the `skillup-headless-content.zip` from the [GITHUB](https://github.com/guptapawan86/apac-skillup-2024) using [Package Manager](http://localhost:4502/crx/packmgr/index.jsp).
...
1. Complete the implementation steps:
       ...
       Implement Event Landing Page Functionality
       Implement Event Detail Page Functionality
